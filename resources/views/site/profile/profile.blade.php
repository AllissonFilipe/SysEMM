...
<div class="box">
    <div class="box-body">
        ...
        <form action="{{ route('user.put', auth()->user()->id) }}" method="POST" enctype="multipart/form-data"
            onsubmit="return confirm('Confirma a alteração ?')">
            {{ method_field('PUT') }}
            {!! csrf_field() !!}
                ...
                <fieldset class="form-froup">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" id="data_de_nascimento" name="data_de_nascimento" class="form-control"
                            value="{{auth()->user()->data_de_nascimento}}" required />
                    </div>
                    <div class="form-group col-md-6">
                        <label for="cpf">CPF</label>
                        <input type="text" id="cpf" name="cpf" class="form-control" value="{{auth()->user()->cpf}}"
                            required />
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" id="tipo" name="tipo" required>
                            <option value="{{auth()->user()->tipo}}" selected>{{auth()->user()->tipo}}</option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="password" id="password_confirm" name="password_confirm"
                            placeholder="Confirmar a Senha" class="form-control" required />
                    </div>
                ...
                <fieldset class="form-group">
                    ...
                    <div class="row">
                        <div style="margin-left: 15px;" class="form-group col-md-2">
                            ...
                            <input class="form-control" id="cep" name="cep" type="text" value="{{auth()->user()->cep}}"
                                required />
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control" id="uf" name="uf" required>
                            <option value="{{auth()->user()->uf}}" selected>{{auth()->user()->uf}}</option>
