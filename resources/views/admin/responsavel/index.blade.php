...
<div class="box">
    <div class="box-header">
        <a href="{{route('responsavel.create')}}" class="btn_1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td id="center">
                                ...
                                <button data-toggle="modal" data-target="#ModalCentralizado<?php echo ($responsavel->id); ?>" class="btn_5">
                                    Visualizar
                                </button>&nbsp;
                                <a href="{{route('responsavel.edit', $responsavel->id)}}" data-toggle="tooltip" data-placement="top" title="Alterar" class="btn_2">Editar</a>
