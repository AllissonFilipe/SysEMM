                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td id="center">
                                        ...
                                        &nbsp;<form style="display: inline-block;" method="POST" action="{{route('responsavel.delete', $responsavel->id)}}" data-toggle="tooltip" data-placement="top" title="Excluir" onsubmit="return confirm('Confirma a exclusão ?')">
