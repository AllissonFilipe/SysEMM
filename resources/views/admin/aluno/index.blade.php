                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td id="center">
                                        ...
                                        &nbsp;<form style="display: inline-block;" method="POST" action="{{route('aluno.delete', $aluno->id)}}" data-toggle="tooltip" data-placement="top" title="Excluir" onsubmit="return confirm('Confirma a exclusão ?')">
